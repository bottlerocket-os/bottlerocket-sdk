...
When filing an issue, please check [existing open](https://github.com/bottlerocket-os/bottlerocket-sdk/issues) and [closed](https://github.com/bottlerocket-os/bottlerocket-sdk/issues?q=is%3Aissue+is%3Aclosed) issues to make sure somebody else hasn't already reported the issue.
...
3. You check existing [open](https://github.com/bottlerocket-os/bottlerocket-sdk/pulls) and [merged](https://github.com/bottlerocket-os/bottlerocket-sdk/pulls?q=is%3Apr+is%3Aclosed) pull requests to make sure someone else hasn't addressed the problem already.
...
As our projects, by default, use the default GitHub issue labels (enhancement/bug/duplicate/help wanted/invalid/question/wontfix), looking at any ['help wanted'](https://github.com/bottlerocket-os/bottlerocket-sdk/labels/help%20wanted) issues is a great place to start.
